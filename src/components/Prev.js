...
export default function DPPrev({ dataPrevBanner, dataPrevBanner2 }) {
  return (
    <div className="overflow-hidden relative pt-12 h-[100vh]">
      <Link to="/PrevDetail">
        <div className="z-[1] absolute flex items-center p-5 top-[53%] left-[50%] translate-x-[-50%] translate-y-[-50%] hover:cursor-pointer hover:text-gray-400">
          <div className="text-4xl">지난 전시 둘러보기</div>
